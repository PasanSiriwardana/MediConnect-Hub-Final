...
$user = isset($_SESSION['usr']) ? $_SESSION['usr'] : null; // Check if $_SESSION['usr'] is set
...
<div id="notification" class="notification"></div>
    ...
    <article>
      ...
      <section class="section service" id="service" aria-label="service">
        <div class="container">
          ...
          <form class="donor-form" action="table.php" method="POST">
  ...
  <footer class="footer">
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <a href="mailto:contact@mediconnect.lk" class="footer-link">contact@mediconnecthub.lk</a>
          </li>
        </ul>
      </div>
    </div>
    <div class="footer-bottom">
      <div class="container">
        <a href="https://swiftwindrp.000webhostapp.com/"><a href="https://swiftwindrp.000webhostapp.com/"><p class="copyright">
