...
<head>
    ...
    <title>MediConnect Hub | Report Make</title>
        ...
        <div class="row">
            <div class="col-12 mt-4">
                ...
                <section class="section service" id="service" aria-label="service">
                    <div class="container">
                        <p class="section-subtitle text-center">Doctor Report Maker</p>

                        <!-- Replace the existing content with your form -->
                       

                        <form class="donor-form" action="report_add_proccess.php" method="POST">
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" id="age" name="age"  value="<?php echo $d['bu_age']; ?>" required>
            </div>

            <div class="form-group">
              <label for="discribe-illness">Discribe the Illness:</label>
              <textarea id="discribe_illness" name="discribe_illness" rows="4" cols="79" required></textarea>
            </div>

            <div class="form-group">
              <label for="discribe-medicine">Discribe the Medicine:</label>
              <textarea id="describe_medicine" name="describe_medicine" rows="4" cols="79" required></textarea>
            </div>
