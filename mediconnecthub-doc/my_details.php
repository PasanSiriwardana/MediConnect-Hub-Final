        ...
        <div class="container">
          ...
          <form class="donor-form" action="process_update_profile.php" method="POST">
            <div class="form-group">
              ...
              <input type="text" id="name" name="name"  value="<?php echo $user['med_name']; ?>">
            </div>

            <div class="form-group">
              <label for="age">Age:</label>
              <input type="text" id="age" name="age" value="<?php echo $user['med_age']; ?>"required>
            </div>

            <div class="form-group">
              <label for="phone">Phone:</label>
              <input type="tel" id="phone" name="phone" required oninput="formatPhoneNumber(this)" value="<?php echo $user['med_phone']; ?>">
            </div>

            <div class="form-group">
              <label for="city">City:</label>
              <input type="text" id="city" name="city" value="<?php echo $user['med_city']; ?>"required>
            </div>

            <div class="form-group">
              <label for="state">Province:</label>
              <select id="state" name="state">
                <option value="Central Province" <?php echo ($user['med_state'] === 'Central Province') ? 'selected' : ''; ?>>Central Province</option>
                <option value="Eastern Province" <?php echo ($user['med_state'] === 'Eastern Province') ? 'selected' : ''; ?>>Eastern Province</option>
                <option value="Northern Province" <?php echo ($user['med_state'] === 'Northern Province') ? 'selected' : ''; ?>>Northern Province</option>
                <option value="North Central Province" <?php echo ($user['med_state'] === 'North Central Province') ? 'selected' : ''; ?>>North Central Province</option>
                <option value="North Western Province" <?php echo ($user['med_state'] === 'North Western Province') ? 'selected' : ''; ?>>North Western Province</option>
                <option value="Sabaragamuwa Province" <?php echo ($user['med_state'] === 'Sabaragamuwa Province') ? 'selected' : ''; ?>>Sabaragamuwa Province</option>
                <option value="Southern Province" <?php echo ($user['med_state'] === 'Southern Province') ? 'selected' : ''; ?>>Southern Province</option>
                <option value="Uva Province" <?php echo ($user['med_state'] === 'Uva Province') ? 'selected' : ''; ?>>Uva Province</option>
                <option value="Western Province" <?php echo ($user['med_state'] === 'Western Province') ? 'selected' : ''; ?>>Western Province</option>
              </select>
            </div>

            <div class="form-group">
              <label for="hospital_id">Hospital ID:</label>
              <input type="text" id="hospital_id" name="hospital_id" value="<?php echo $user['med_hospital_id']; ?>"required>
            </div>

            <div class="form-group">
              <label for="special">Specialization:</label>
              <input type="text" id="special" name="special" value="<?php echo $user['med_special']; ?>"required>
            </div>

            <div class="form-group">
              <label for="po_address">Postal address:</label>
              <input type="text" id="po_address" name="po_address" value="<?php echo $user['med_po_address']; ?>"required>
            </div>
