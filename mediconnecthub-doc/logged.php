        ...
        <div class="row">
            <div class="col-12 mt-4">
                ...
                <section class="section service" id="service" aria-label="service">
                    <div class="container">
                        <h2 class="h2 section-title text-center">Doc Portal</h2>

                        <!-- Replace the existing content with your form -->

                        <?php
                    $rs = Database::search("SELECT * FROM doc_user WHERE med_id='" . $_GET['id'] . "';");
                    ...
                    <form class="donor-form">
                            ...
                            <div class="form-group">
                                ...
                                <h4><a href="mailto:<?= $d['med_email']; ?>"><?= $d['med_email']; ?></a></h4>
                            </div>
                        ...
                        <br>
                        <input id="text" type="text" value="http://localhost/mediconnecthub/scanned.php?id=<?= $d['med_id']; ?>" style="width:80%;
                                                                                                      visibility:hidden;" />
                        
    </script>
                        <br><br>
                        <center><a class="btn btn-primary" href="index.php">Go Back</a>
                        <a class="btn btn-primary" href="my_details.php">Edit Profile</a>
                        <a class="btn btn-primary" href="scan.html" target="_blank">Scan QR Code</a></center>
                    </div>
                </section>
